...
@section('content')
    @if ($vendor->status == 0)
        <div class="alert alert-warning">Your account is under verification. Once verified, you will be able to add services.
        </div>
    @endif
    <div class="card mb-4">
        ...
        <div class="card-body">
            <div>
                <img src="{{ asset('public/images/vendor/'.$vendor->image) }}" alt="Institute Image" class="img-fluid mb-3 w-25">
            </div>
            <table class="table table-bordered table-responsive">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>Tags</td>
                        <td>
                            <span class="badge bg-secondary">Aviation Colleges</span>
