    ...
    <div class="row">
        <div class="col-lg-7 col-md-7 col-sm-7">
            <div class="text-center">
                <img src="{{asset('public/assets/img/ads.webp')}}" alt="" width="100%">
            </div>
        </div>
        <div class="col-lg-5 col-md-5 col-sm-5">
            <div class="list-form-section">
              <h2 class="head-h2-list">SELL or RENT your property quicker with Sulekha Properties</h2>
              <div class="start-now">
...
<div class="section-used ">
    <div class="container p-5">
        <h2 class="head-h2 text-center">How it works?</h2>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-4">
               <div class="text-center">
                   <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"   width="176.27" height="128.354" viewBox="0 0 176.27 128.354">
                     ...
                     <g id="Group_6246" data-name="Group 6246" transform="translate(-354 -1116.177)">
                      ...
                      <text id="Verified" transform="translate(440 1194)" fill="#fff" font-size="19" font-family="ProximaNova-Medium, Proxima Nova" font-weight="500"><tspan x="0" y="0">Verified</tspan></text>
               ...
               <div>
                 <h2 class="head-h2 text-center">Post Your Property Ad</h2>
                 <p class="text-center">Share property details and upload photos.</p>
               </div>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-4">
               <div class="text-center">
               ...
               <div>
                 <h2 class="head-h2 text-center">Check Response via SMS / Whats App / Dashboard</h2>
            ...
            <div class="col-lg-4 col-md-4 col-sm-4">
               ...
               <div>
                 <h2 class="head-h2 text-center">Fast Sell or Rent with Instant Connect</h2>
