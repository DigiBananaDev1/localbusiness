            ...
            @forelse ($vendors as $vendor)
                <div class="item text-center p-2 bg-white rounded shadow-sm">
                    <a href="{{ route('venderServices', $vendor->slug) }}">
                        <img src="{{ asset('public/images/vendor/' . $vendor->image) }}" alt="AC Repair"
                            class="category-img mb-2">
                        <span class="text-dark fw-medium text-decoration-none">
            ...
            <div class="col-md-3 col-sm-6 mb-4">
                <div class="card card-custom h-100">
                    ...
                    <div class="card-body text-center">
                        <h5 class="card-title mb-1 fw-bold">
                            <a href="#" class="text-decoration-none text-dark"><img
                                    src="{{ asset('public/assets/img/verified.png') }}" width="20px"> Babu Lohar
                                Shop</a>
                        </h5>
                        <div class="mb-1"><span class="rating-box">4.2 ★</span> <span>87 ratings</span></div>
                        <p class="text-muted mb-2">Nehru Place - Delhi</p>
            ...
            <div class="col-md-3 col-sm-6 mb-4">
                <div class="card card-custom h-100">
                    ...
                    <div class="card-body text-center">
                        <h5 class="card-title mb-1 fw-bold">
                            <a href="#" class="text-decoration-none text-dark"><img
                                    src="{{ asset('public/assets/img/verified.png') }}" width="20px"> DNEST
                                COMPUTER</a>
                        </h5>
                        <div class="mb-1"><span class="rating-box">4.2 ★</span> <span>87 ratings</span></div>
                        <p class="text-muted mb-2">Nehru Place - Delhi</p>
