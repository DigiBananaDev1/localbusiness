...
@section('content')
    ...
    <div class="container mt-1">
        <div class="row">
            ...
            <div class="col-md-4">
                <a href="{{ route('vendors.byType', 'product') }}">
                    <div class="rb1 mb-1">
                ...
                <a href="{{ route('vendors.byType', 'service') }}">
                    <div class="rb2">
                        <div class="text-content">
                ...
                <div class="col-md-6">
                    ...
                    <div class="owl-carousel education-carousel">
                        @foreach ($vendors as $vendor)
                            <div class="item">
                                <a href="{{ route('venderServices', $vendor->slug) }}">
                                ...
                                <div>
                                    <a class="product-title"
                                        href="{{ route('venderServices', $vendor->slug) }}">{{ $vendor->business_name }}</a>
                                </div>
                                <div class="qsection">
                                    <span class="experts text-muted">5624 Experts</span>
                                    <a class="get-qbtn" href="{{ route('venderServices', $vendor->slug) }}">GET QUOTES</a>
                                </div>
                            </div>
                        @endforeach
                    </div>
